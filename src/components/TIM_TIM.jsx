const TIM_TIM = () =>{
    ...
    <div className="stages">
        ...
        <div className="cent-cont">
            <span>Lorem ipsum dolor, sit amet consectetur adipisicing elit. 
                Quaerat eaque, quidem id, necessitatibus porro illum blanditiis 
                alias eos nesciunt quos facere cum distinctio quas labore consequuntur? Cum nesciunt natus enim.
            </span>
            ...
            <div className="graph-line">
                ...
                <div id="third-sec">
                <span>End <br/>21 october 2023</span>
                </div>
                <div className="graph-image">
                    <img src="src\assets\new_assets\chart.svg" alt=""/>
                </div>
                </div>

                <div className="side_line">
                    <span>Lorem ipsum dolor, sit amet consectetur adipisicing elit. 
                        Esse non magnam possimus odit, debitis, quisquam hic commodi eveniet beatae rem porro ullam veniam 
                        totam ipsam dolores perferendis molestiae minus. Porro.</span>

                        <div className="eve_vec">
                        <div className="team_sort">
                            12 Team Shortlisted
                        </div>
                        <div className="group19">
                            <img src="src\assets\new_assets\Group19.svg" alt="" />
                        </div>
                        <div className="date_eve">
                            30th October,2023
                        </div>
                        </div>
                </div>
    ...
    <div className="write_up">
            ...
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet voluptate pariatur minima magnam autem? 
            Quod earum at eius, et quia.
            </p>
